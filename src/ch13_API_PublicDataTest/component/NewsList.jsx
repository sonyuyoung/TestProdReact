...
const NewsList = ({ category }) => {
  ...
  // 상태변수 ,뉴스(0) , 공공데이터에(1,2) : 푸드, 도보 따라서
  const [datatype, setDatatype] = useState(0);

  // "https://newsapi.org/v2/top-headlines?country=kr&{query}&apiKey=bf6ce38e4a4a4b15a4778c02352e8c23"
  // `https://newsapi.org/v2/top-headlines?country=kr&category=${query}&apiKey=bf6ce38e4a4a4b15a4778c02352e8c23`
  useEffect(() => {
